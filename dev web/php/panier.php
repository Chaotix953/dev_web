...
$products = extractProduct($_SESSION['products']);
        ...
        <main>
           ...
           <?php }?>
            <div class="payer">
                ...
                <button id="btn1"><a href="./login.php" style="color: aliceblue; font-weight:bold ; text-decoration: none; text-transform: uppercase;" >Identification</a></button>
                ...
                <button id="btn2"><a href="./pay.php" style="color: aliceblue; font-weight:bold ; text-decoration: none; text-transform: uppercase;">Terminer la commande</a></button>
